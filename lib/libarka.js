...
Libarka.prototype.connect = function (connectionUrl) {
    ...
    return amqplib.connect(connectionUrl).then(function (connection) {
        ...
        return that._assertSystemExchange().then(function () {
            return that.systemChannel.assertQueue('').then(function (queue) {
...
Libarka.prototype.pause = function () {
    ...
    return this._assertSystemExchange().then(function () {
        return that.systemChannel.publish(that.config.systemChannelName, '#', new Buffer('pause'));
    }).then(function () {
...
Libarka.prototype.resume = function () {
    var that = this;
    return this._assertSystemExchange().then(function () {
        return that.systemChannel.publish(that.config.systemChannelName, '#', new Buffer('resume'));
    }).then(function () {
            // TODO this is really temporary
            return Promise.delay(100);
        });
